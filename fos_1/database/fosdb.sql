...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2020 at 07:40 PM
...
CREATE TABLE `tblodrdeli` (
  `id` int(15) NOT NULL,
  `deli_id` int(15) DEFAULT NULL,
  `ode_id` int(15) DEFAULT NULL,
...
INSERT INTO `tblodrdeli` (`id`, `deli_id`, `ode_id`, `deliv_status`) VALUES
(1, 5, 170244505, 'COMPLETED'),
(2, 3, 270156472, 'COMPLETED'),
(3, 1, 448858080, 'COMPLETED'),
(4, 3, 448858080, 'COMPLETED'),
(5, 3, 448858080, 'COMPLETED'),
(6, 3, 270156472, 'COMPLETED'),
(7, 3, 170244505, 'COMPLETED'),
(8, 3, 270156472, 'COMPLETED'),
(9, 3, 270156472, 'COMPLETED');
...
CREATE TABLE `tblorderaddresses` (
  ...
  `latit` int(150) DEFAULT NULL,
  `longit` int(150) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(21, '3', '8', NULL, NULL, NULL),
(22, '3', '8', NULL, NULL, NULL),
...
(6, 'ARNAB', 'ROY', 'arnabroni312@gmail.com', 9874991140, '81dc9bdb52d04dc20036dbd8313ed055', '2020-04-03 10:02:35');
